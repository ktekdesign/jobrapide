import { LegacyRef, SelectHTMLAttributes, forwardRef, memo, useId } from 'react'
...
const Select = forwardRef(
  (
    ...
    return (
      <StringComponent as="div" cond={options?.length > 0} className="row">
        <Label htmlFor={id}>{title}</Label>
        <div className="relative">
          <select id={id} ref={ref} className="form-select" {...props}>
